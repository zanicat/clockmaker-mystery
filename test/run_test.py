...
ALL_TESTS = ['walkthrough-ch1.js', 'walkthrough-ch2.js', 'walkthrough-ch3.js', 'walkthrough-ch4.js', 'walkthrough-ch5.js', 'test-migration.js', 'test-cross-chapter.js', 'test-jar-labels.js']


def run_one(name):
    ctx = MiniRacer()
    ctx.eval(open(os.path.join(HERE, 'dom-stub.js')).read())
    for js in ['art.js', 'art-ch2.js', 'art-ch3.js', 'art-ch4.js', 'art-ch5.js', 'sfx.js', 'data-ch1.js', 'data-ch2.js', 'data-ch3.js', 'data-ch4.js', 'data-ch5.js', 'engine.js']:
